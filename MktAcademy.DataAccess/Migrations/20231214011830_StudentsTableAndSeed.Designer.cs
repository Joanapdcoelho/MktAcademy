...
namespace MktAcademy.DataAccess.Migrations
{
    ...
    [Migration("20231214011830_StudentsTableAndSeed")]
    partial class StudentsTableAndSeed
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MktAcademy.Models.Enrollment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MktAcademy.Models.Instructor", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MktAcademy.Models.OrderDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MktAcademy.Models.OrderHeader", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MktAcademy.Models.ShoppingCart", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MktAcademy.Models.Enrollment", b =>
                {
                    ...
                    b.HasOne("MktAcademy.Models.Student", "Student")
                        .WithMany()
            ...
            modelBuilder.Entity("MktAcademy.Models.OrderDetail", b =>
                {
                    ...
                    b.HasOne("MktAcademy.Models.OrderHeader", "OrderHeader")
                        .WithMany()
            ...
            modelBuilder.Entity("MktAcademy.Models.ApplicationUser", b =>
                {
                    b.HasOne("MktAcademy.Models.Company", "Company")
                        .WithMany()
